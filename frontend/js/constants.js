...
const p_presale_mint_not_approvedlist = "You are not approvedlist for the pre-sale.. 😢";
const p_presale_mint_approvedlist = "You're on the approvedlist for the pre-sale! 🎉";
const p_presale_mint_already_minted = "You've already claimed your approvedist mint. Thank you! 🎉";
const p_public_mint = "No approvedlist needed. Public minting is now open! 🎉";
const button_presale_coming_soon = "Get on the ApprovedList";
const button_presale_mint_approvedlist = "Mint Your Special NFT";
const button_presale_mint_not_approvedlist = "Get on the ApprovedList";
